...
// Read OAuth credentials from environment. Do NOT hardcode secrets.
const OAUTH_CLIENT_ID = process.env.GEMINI_OAUTH_CLIENT_ID || 'CHANGE_ME'
const OAUTH_CLIENT_SECRET = process.env.GEMINI_OAUTH_CLIENT_SECRET || 'CHANGE_ME'
